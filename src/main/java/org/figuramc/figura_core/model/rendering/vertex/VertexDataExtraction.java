...
/**
 * Helper functions for extracting vertex data from module materials into actual vertex data
 */
public class VertexDataExtraction {

    /**
     * Add vertices for the given CubeData
     */
    public static void addVertices(PartVertexData.Builder vertexData, ModuleMaterials.CubeData cubeData) {
    ...
    /**
     * Add vertices for the given MeshData
     */
    public static void addVertices(PartVertexData.Builder builder, ModuleMaterials.MeshData meshData) {
    ...
    /**
     * Emit a vertex with default skinning info
     */
    public static void noSkinVert(PartVertexData.Builder builder, float x, float y, float z, float u, float v, float nx, float ny, float nz, float tx, float ty, float tz, @Nullable Matrix4f transform, @Nullable Matrix3f normalMat) {
        emitVert(builder, x, y, z, u, v, nx, ny, nz, tx, ty, tz, 0, -1, -1, -1, 1f, 0f, 0f, 0f, transform, normalMat);
    }

    /**
     * Emit a vertex in the most verbose way possible.
     */
    ...
    /**
     * Extrude a texture and add its vertices to the builder.
     */
    public static void extrudeTexture(PartVertexData.Builder builder, AvatarTexture texture) {
