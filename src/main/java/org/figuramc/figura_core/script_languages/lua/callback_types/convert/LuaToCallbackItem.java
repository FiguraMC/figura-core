...
public class LuaToCallbackItem implements CallbackType.ToItemVisitor<LuaValue, LuaError, LuaUncatchableError> {
    ...
    @Override
    public CallbackItem.Opaque visit(CallbackType.Opaque __, LuaValue value) throws LuaError, LuaUncatchableError {
        return new CallbackItem.Opaque(value); // Wrap the LuaValue directly into the Opaque.
    }

    @Override
    public CallbackItem visit(CallbackType.Any __, LuaValue value) throws LuaError, LuaUncatchableError {
        return switch (value) {
    ...
    @Override
    public <K extends CallbackItem, V extends CallbackItem> MapView<K, V> visit(CallbackType.Map<K, V> map, LuaValue value) throws LuaError, LuaUncatchableError {
    ...
    @Override
    public <I extends CallbackItem, O extends CallbackItem> FuncView<I, O> visit(CallbackType.Func<I, O> func, LuaValue value) throws LuaError, LuaUncatchableError {
        return new FuncView<>(new LuaCallback<>(func, state, value));
    }

    @Override
    public <T extends CallbackItem> CallbackItem.Optional<T> visit(CallbackType.Optional<T> optional, LuaValue value) throws LuaError, LuaUncatchableError {
    ...
    // Tuples
    @Override
    public <A extends CallbackItem, B extends CallbackItem> CallbackItem.Tuple2<A, B> visit(CallbackType.Tuple2<A, B> tuple, LuaValue value) throws LuaError, LuaUncatchableError {
    ...
    @Override
    public <A extends CallbackItem, B extends CallbackItem, C extends CallbackItem> CallbackItem.Tuple3<A, B, C> visit(CallbackType.Tuple3<A, B, C> tuple, LuaValue value) throws LuaError, LuaUncatchableError {
        LuaTable tab = value.checkTable(state);
    ...
    @Override
    public <A extends CallbackItem, B extends CallbackItem, C extends CallbackItem, D extends CallbackItem> CallbackItem.Tuple4<A, B, C, D> visit(CallbackType.Tuple4<A, B, C, D> tuple, LuaValue value) throws LuaError, LuaUncatchableError {
        LuaTable tab = value.checkTable(state);
    ...
    @Override
    public <A extends CallbackItem, B extends CallbackItem, C extends CallbackItem, D extends CallbackItem, E extends CallbackItem> CallbackItem.Tuple5<A, B, C, D, E> visit(CallbackType.Tuple5<A, B, C, D, E> tuple, LuaValue value) throws LuaError, LuaUncatchableError {
        LuaTable tab = value.checkTable(state);
    ...
    @Override
    public <A extends CallbackItem, B extends CallbackItem, C extends CallbackItem, D extends CallbackItem, E extends CallbackItem, F extends CallbackItem> CallbackItem.Tuple6<A, B, C, D, E, F> visit(CallbackType.Tuple6<A, B, C, D, E, F> tuple, LuaValue value) throws LuaError, LuaUncatchableError {
        LuaTable tab = value.checkTable(state);
    ...
    @Override
    public <A extends CallbackItem, B extends CallbackItem, C extends CallbackItem, D extends CallbackItem, E extends CallbackItem, F extends CallbackItem, G extends CallbackItem> CallbackItem.Tuple7<A, B, C, D, E, F, G> visit(CallbackType.Tuple7<A, B, C, D, E, F, G> tuple, LuaValue value) throws LuaError, LuaUncatchableError {
        LuaTable tab = value.checkTable(state);
