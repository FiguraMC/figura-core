...
public class Vec2API {
    ...
    @LuaExpose @LuaPassState public static LuaValue __index(LuaRuntime s, Vector2d self, LuaValue key) throws LuaError, LuaUncatchableError {
    ...
    @LuaExpose @LuaPassState public static void __newindex(LuaRuntime s, Vector2d self, LuaValue key, LuaValue value) throws LuaError, LuaUncatchableError {
    ...
    private static void setSwizzle(Vector2d v, char c, double num, LuaState state) throws LuaError, LuaUncatchableError {
        switch (c) {
            case '_' -> {}
            case 'x', 'r', 'u' -> v.x = num;
            case 'y', 'g', 'v' -> v.y = num;
