...
public class WorldViewAPI {
    ...
    public static LuaTable players(LuaRuntime s, WorldView<?> self) throws LuaError, LuaOOM {
    ...
    @LuaExpose @LuaPassState
    public static LuaTable entities(LuaRuntime s, WorldView<?> self) throws LuaError, LuaOOM {
        LuaTable table = new LuaTable(s.allocationTracker);
        int[] i = new int[1];
    ...
    @LuaExpose @LuaPassState
    public static LuaValue getMapData(LuaRuntime s, WorldView<?> self, int id) throws LuaError, LuaOOM {
    ...
    @LuaExpose @LuaPassState
    public static BlockStateView<MinecraftBlockState> blockState(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return new BlockStateView<>(fetchWorld(s, self).getBlockState(x, y, z), self);
    }
    @LuaExpose @LuaPassState
    public static BlockStateView<MinecraftBlockState> blockState(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
        return blockState(s, self, (int) pos.x, (int) pos.y, (int) pos.z);
    }

    /* TODO: ItemStackAPI must exist before implementation
    @LuaExpose @LuaPassState
    public static <MinecraftBlockState> newItem(LuaState s, WorldView<?> self, String data, int count, int damage) throws LuaError, LuaOOM {
        return new <>(fetchWorld(s, self).newItem(data, count, damage));
    }*/

    @LuaExpose @LuaPassState
    public static EntityView<MinecraftEntity> entity(LuaState s, WorldView<?> self, UUID uuid) throws LuaError, LuaOOM {
        MinecraftEntity entity = fetchWorld(s, self).getEntity(uuid);
        return entity == null ? null : new EntityView<>(entity, self);
    }

    @LuaExpose @LuaPassState
    public static String dimension(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getDimension().toString();
    }

    @LuaExpose @LuaPassState
    public static int redstonePower(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getRedstonePower(x, y, z);
    }
    @LuaExpose @LuaPassState
    public static int redstonePower(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
        return redstonePower(s, self, (int) pos.x, (int) pos.y, (int) pos.z);
    }

    @LuaExpose @LuaPassState
    public static int strongRedstonePower(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getStrongRedstonePower(x, y, z);
    }
    @LuaExpose @LuaPassState
    public static int strongRedstonePower(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
        return strongRedstonePower(s, self, (int) pos.x, (int) pos.y, (int) pos.z);
    }

    @LuaExpose @LuaPassState
    public static int moonPhase(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getMoonPhase();
    }

    @LuaExpose @LuaPassState
    public static int lightLevel(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getLightLevel(x, y, z);
    }
    @LuaExpose @LuaPassState
    public static int lightLevel(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
        return lightLevel(s, self, (int) pos.x, (int) pos.y, (int) pos.z);
    }

    @LuaExpose @LuaPassState
    public static int skyLightLevel(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getSkyLightLevel(x, y, z);
    }
    @LuaExpose @LuaPassState
    public static int skyLightLevel(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
        return skyLightLevel(s, self, (int) pos.x, (int) pos.y, (int) pos.z);
    }

    @LuaExpose @LuaPassState
    public static int blockLightLevel(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getBlockLightLevel(x, y, z);
    }
    @LuaExpose @LuaPassState
    public static int blockLightLevel(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
        return blockLightLevel(s, self, (int) pos.x, (int) pos.y, (int) pos.z);
    }

    @LuaExpose @LuaPassState
    public static int height(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getHeight();
    }

    @LuaExpose @LuaPassState
    public static long time(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getTime();
    }

    @LuaExpose @LuaPassState
    public static double timeOfDay(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getTimeOfDay();
    }

    @LuaExpose @LuaPassState
    public static double day(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getDay();
    }

    @LuaExpose @LuaPassState
    public static double rainGradient(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return rainGradient(s, self, 1.0f);
    }
    @LuaExpose @LuaPassState
    public static double rainGradient(LuaState s, WorldView<?> self, float delta) throws LuaError, LuaOOM {
        return fetchWorld(s, self).getRainGradient(delta);
    }

    @LuaExpose @LuaPassState
    public static boolean isChunkLoaded(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return fetchWorld(s, self).isChunkLoaded(x, y, z);
    }
    @LuaExpose @LuaPassState
    public static boolean isChunkLoaded(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
        return isChunkLoaded(s, self, (int) pos.x, (int) pos.y, (int) pos.z);
    }

    @LuaExpose @LuaPassState
    public static boolean isThundering(LuaState s, WorldView<?> self) throws LuaError, LuaOOM {
        return fetchWorld(s, self).isThundering();
    }

    @LuaExpose @LuaPassState
    public static boolean isOpenSky(LuaState s, WorldView<?> self, int x, int y, int z) throws LuaError, LuaOOM {
        return fetchWorld(s, self).isOpenSky(x, y, z);
    }
    @LuaExpose @LuaPassState
    public static boolean isOpenSky(LuaState s, WorldView<?> self, Vector3d pos) throws LuaError, LuaOOM {
