...
public class BlockStateViewAPI {
    ...
    @LuaExpose @LuaPassState
    public static BlockStateView<?> at(LuaRuntime s, BlockStateView<?> self, Vector3d newPos) throws LuaError, LuaUncatchableError {
...
//    }
    ...
    private static LuaTable processVoxelShape(LuaRuntime s, List<MinecraftBlockState.AABB> shape) throws LuaUncatchableError {
